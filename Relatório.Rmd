...
## Função 15: Calcula a distribuição estacionária para uma cadeia de Markov
calcular.distribuicao.estacionaria <- function(P) {
...
## Função 16: Calcula a probabilidade de transição \( P_L(w,s) \) para cada estado (w,s)
...
calcular.custos <- function(p_mais, p_menos, alfa, beta, 
  ...
  # Função para calcular xi e phi de maneira robusta
  calcular_xi_theta_phi <- function(state, p_mais, p_menos, alfa, beta, 
                                    c_inspecao, c_ajuste, c_desc_c, 
                                    c_desc_nc, c_nc, p_AS, p_AF, p_L, 
                                    pi, L, m) {
    # Verifica cada estado e calcula os custos de xi, theta e phi
    if (state == "(0,0)") {
      p_m_00 <- p_L[1]
      p_L_00 <- p_L[1]
      ...
      # Exibir resultados para (0,0)
      print(paste("Estado (0,0):"))
      print(paste("  xi(0,0):", xi_00))
      print(paste("  theta(0,0):", theta_00))
      print(paste("  phi(0,0):", phi_00))
    ...
    if (state == "(0,1)") {
      ...
      # Exibir resultados para (0,1)
      print(paste("Estado (0,1):"))
      print(paste("  xi(0,1):", xi_01))
      print(paste("  theta(0,1):", theta_01))
      print(paste("  phi(0,1):", phi_01))
    ...
    if (state == "(1,0)") {
      ...
      # Exibir resultados para (1,0)
      print(paste("Estado (1,0):"))
      print(paste("  xi(1,0):", xi_10))
      print(paste("  theta(1,0):", theta_10))
      print(paste("  phi(1,0):", phi_10))
    ...
    if (state == "(1,1)") {
      ...
      # Exibir resultados para (1,1)
      print(paste("Estado (1,1):"))
      print(paste("  xi(1,1):", xi_11))
      print(paste("  theta(1,1):", theta_11))
      print(paste("  phi(1,1):", phi_11))
    ...
    if (state == "(2,0)") {
      ...
      # Exibir resultados para (2,0)
      print(paste("Estado (2,0):"))
      print(paste("  xi(2,0):", xi_20))
      print(paste("  theta(2,0):", theta_20))
      print(paste("  phi(2,0):", phi_20))
    ...
    if (state == "(2,1)") {
      ...
      # Exibir resultados para (2,1)
      print(paste("Estado (2,1):"))
      print(paste("  xi(2,1):", xi_21))
      print(paste("  theta(2,1):", theta_21))
      print(paste("  phi(2,1):", phi_21))
...
PI <- calcular.distribuicao.estacionaria(matriz.P)
p.L <- calcular.pL(matriz.P, PI)
